variable "enabled" {
  description = "Enable creation of AWS Backup resources"
  type        = bool
  default     = true
}

variable "vault_name" {
  description = "Name of the custom backup vault to be created. If not provided, AWS default vault will be used"
  type        = string
  default     = null
}
...
variable "plan_name" {
  description = "The name used for your backup plan"
  type        = string
}

variable "rule_name" {
  description = "An name used for your backup rule"
  type        = string
  default     = null
}
